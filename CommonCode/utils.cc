...
float calcSigmaMllg(float Mllg, float e1,float sigmae1,float e2,
		    float sigmae2,float e3,float sigmae3,
		    float costheta12,
		    float costheta13,
		    float costheta23
		    ){
  ...
  float sigma = pow( ( e2*(1-costheta12)+e3*(1-costheta13) ) * sigmae1,2) 
    + pow( ( e1*(1-costheta12)+e3*(1-costheta23) ) * sigmae2,2) 
    + pow( ( e1*(1-costheta13)+e2*(1-costheta23) ) * sigmae3,2) ; 
  
  return sqrt( sigma / Mllg );  
